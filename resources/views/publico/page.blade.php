@extends('publico.template.layout')
@section('content')

    <div class="col-lg-12 col-md-12">
        <quiz-aleatorio></quiz-aleatorio>
{{--        <aside>--}}
{{--            <div class="content-title">--}}
{{--                <div class="text-center">--}}
{{--                    <h3><a href="#">Quando você vai se casar?</a></h3>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <img src="https://lh3.googleusercontent.com/-ndZJOGgvYQ4/WM1ZI8dH86I/AAAAAAAADeo/l67ZqZnRUO8QXIQi38bEXuxqHfVX0TV2gCJoC/w424-h318-n-rw/thumbnail8.jpg" style="width: 100%" class="img-responsive">--}}
